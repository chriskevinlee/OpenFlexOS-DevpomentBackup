...
# # Coping wallpaper changer script
# cp ./OpenFlexOS-Configs/usr/local/bin/OpenFlexOS_WallpaperChanger.sh /etc/openflexos/usr/local/bin/OpenFlexOS_WallpaperChanger.sh
# cp ./OpenFlexOS-Configs/usr/share/applications/OpenFlexOS_Wallpaper.desktop /etc/openflexos/usr/share/applications/OpenFlexOS_Wallpaper.desktop
# chmod +x /etc/openflexos/usr/local/bin/OpenFlexOS_WallpaperChanger.sh

# # Coping WebBookmaker script
# cp ./OpenFlexOS-Configs/usr/local/bin/OpenFlexOS_WebBookmarker.sh /etc/openflexos/usr/local/bin/OpenFlexOS_WebBookmarker.sh
# chmod +x /etc/openflexos/usr/local/bin/OpenFlexOS_WebBookmarker.sh

# # Coping nerd dictation
# cp ./OpenFlexOS-Configs/usr/local/bin/OpenFlexOS_NerdDictation /etc/openflexos/usr/local/bin/OpenFlexOS_NerdDictation
# chmod +x /etc/openflexos/usr/local/bin/OpenFlexOS_NerdDictation
